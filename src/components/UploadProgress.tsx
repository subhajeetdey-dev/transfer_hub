  ...
  return (
    <div className="flex flex-col items-center gap-5 p-12 w-full">
      ...
      {totalFiles && totalFiles > 1 && (
        <div className="font-mono text-[10px] tracking-[0.1em] uppercase text-ink-ghost dark:text-white/30">
          File {(fileIndex ?? 0) + 1} of {totalFiles}
        </div>
      )}
      ...
      <div className="relative `w-[100px]` `h-[100px]`">
        <svg
          className="-rotate-90 `w-[100px]` `h-[100px]`"
          viewBox="0 0 100 100"
        >
          <circle
